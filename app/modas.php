...
<html>
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="css/esteas.css">
  </head>
  <body>
      <div class="barrapad">
        <div class="barra">
      ...
      <div id="conpad">
        ...
        <div class="form">
          <h3>Editar datos de asistencia</h3>
          <form action="" method="POST">
              <table id="tabla1">
                <thead>
                  <tr>
                    <td class="tdes"><input type="text" name="idas" required placeholder="Id. asistencia"></td>
                    <td><input type="text" name="docins" required placeholder="Doc. instructor"></td>
                  </tr>
                  <tr>
                    <td class="tdes"><input class="iden" type="text" name="nom" required placeholder="Aprendiz"></td>
                    <td><input class="iden" type="time" name="hl" required value="10:30"></td>
                  </tr>
                </thead>
              </table>
