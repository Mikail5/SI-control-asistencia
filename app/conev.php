...
<html>
  <head>
    ...
    <link rel="stylesheet" href="css/estcev.css">
  </head>
  <body>
    <div class="barrapad">
        <div class="barra">
      ...
      <div id="conpad">
        ...
        <div class="form">
          <h3>Buscar aprendices con fallas o retardos</h3>
          <form action="" method="POST">
              <input class="ce" type="text" name="tip" required placeholder="Doc. aprendiz">
